...
!****************************************************
! This is a Fortran 90 program to write data directly
! to a file by each member of an MPI group. It is suitable
! for large jobs which will not fit into core memory (such as 
! "out of core" solvers)
!****************************************************
...
!   set file name to output datafile
...
!   Basic MPI set-up
    ...
    call MPI_COMM_SIZE(MPI_COMM_WORLD, nprocs, ieer)
